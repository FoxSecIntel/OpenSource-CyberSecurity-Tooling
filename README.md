...
| :-------------- |:---------------------------------------------------| :------------------------------------|
| Cobalt Strike |||||
| OS Query | An open-source, cross-platform query language that allows you to access various information about the hardware and software of a computer system|||
